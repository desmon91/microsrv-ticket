...
it('returns a 400 if the title or price invalid', async()=>{
...
it('updates the ticket successfuly', async()=>{
    const cookie = global.signin()
...
it('rejects the update if the ticket currently being reserved', async()=>{
    const cookie = global.signin()
